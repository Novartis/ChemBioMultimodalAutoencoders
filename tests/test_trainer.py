...
import os
import shutil
from multimodal_autoencoders.train_joint import JointTrainer
...
model_dict = {
    "mod1": VariationalAutoencoder(DynamicEncoder(100, 50, 2), DynamicDecoder(100, 50, 10, 2), "adam", 0.001, pretrain_epochs = 2),
